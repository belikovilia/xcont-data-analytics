...
5 и более нарушений по качеству продукта; 5и более нарушений по качеству продукта; 5 и более нарушений по качеству продуктам; 5 и более нарушений в качестве продукта; :5 и более нарушений по качеству продукта; 5 и более нарушений по продукту; 5 и более нарушений по приготовлению продукта; 5 и более нарушений в приготовлении продукта; :5 и более нарушений в приготовлении продукта

Использование щепотки при работе с ингредиентами
щепоткой; ингредиент щепоткой; сыр щепоткой; томаты щепоткой; лук щепоткой; перец щепоткой; с/с щепоткой; смесь сыров щепоткой; огурцы щепоткой; брынзу щепоткой; креветки щепоткой; халапеньо щепоткой; митболы щепоткой; салат щепоткой; ананасы щепоткой; цыплёнок щепоткой; без использования стакана; не использовали стакан; без стаканчика; без стакана

Использование бракованного продукта / не списан брак
борт порвался; бортик порвался; тесто порвалось; тортилья порвалась; брак не списали; брак не переделали; не списали брак

Ингредиенты подняли с линии в продукт / лексан
вернули в линию; вернули в лексан; ингредиенты из пиццы вернули; с линии в продукт; с линии в лексан; подняли продукт с линии; упавший на линию

Облокачиваются на поверхности
облокачиваются на пищевую поверхность; облокатились на стол; не опищевили; поверхность не опищевили

Работа в фартуке с непищевым
уборка в кухонном фартуке; уборка в фартуке; работают с непищевым в фартуке; с телефоном в фартуке; в кухонном фартуке у пк; трамбуют мусорку в фартуке; передвигают мусорку в фартуке; трогают мусорку в фартуке; работают в наушниках; в фартуке
...
руки не помыли; руки помыли без мыла; руки помыли без антисептика; руки помыли без мыла и антисептика; руки помыли без мыла, антисептика; руки помыли без антисептика и не до локтя; руки помыли без антисептика перед заготовкой салатов; после желтой зоны руки не помыли; после желтой зоны руки помыли без мыла и антисептика; после желой зоны руки помыли без антисептика; после работы с деньгами руки не помыли; после наличных руки не помыли; после ПК руки не помыли; после работы с непищевым руки не помыли; руки после телефона не помыли; руки после уборки не помыли; руки не обработали антисептиком; руки помыли, антисептик вытерли салфеткой; руки не помыли, обработали антисептиком; руки не помыли, не обработали антисептиком; надели перчатки, руки не помыли; надели перчатки после мытья рук без антисептика; надели перчатки после мытья рук без мыла; сняли перчатки, руки не помыли, надели новые; сняли перчатки, руки не помыли, продолжили работу; перчатки не заменили, руки не помыли; перчатки сняли, руки не помыли (нанесли антисептик), надели перчатки; айсберг помыли, перчатки не заменили, руки не помыли; черри помыли, перчатки не заменили, руки не помыли; перец помыли, перчатки не заменили, руки не помыли

Антисептик нанесли на перчатки
антисептик нанесли на перчатки

Контакт непищевых предметов/поверхностей с пищевыми продуктами
...
фасовка без фартука; фасовка без перчаток; фасовка чизкейков без фартука; фасовка десертов без фартука и перчаток; заготовка без фартука; работа с продуктом без фартука (менеджер)

Посуда помыта без дезинфектора / не помыта / в дезинфекторе менее 15 минут
посуда помыта без дезинфекции; посуда помыта без мыла; посуда помыта не по стандарту; посуда в дезинфекторе менее 15 минут; мытьё посуды без дезинфекции; посуду оставили на ночь; мытьё бутылок без ёршика; бутылки моют без ёршика; дезинфекция бутылочек менее 15 минут

Нарушение правил проведения МК
не заменили половник, стакан, инвентарь после мероприятия

Уборка не по стандарту
лексаны протёрты грязной тряпкой; инвентарь для уборки касается пищевого стола

Заготовка в грязный лексан / смешали старое с новым
использование грязной посуды; грязный лексан; грязный нож; грязная доска; заготовка в грязный лексан; смешали старое с новым; добавили старый продукт в новый; не списали продукт в закрытие

Охлажденные / замороженные продукты в тепле дольше 60 минут
продукт в тепле более часа; цыпленок в тепле более часа; лук в тепле более часа; томаты в тепле более часа; перец в тепле более часа; сыр в тепле более часа; шампиньоны в тепле более часа; ветчина в тепле более часа; говядина в тепле более часа; брынза в тепле более часа; молоко в тепле; паста в тепле более часа; ингредиенты в цеху более часа

Продукт без маркировки / просроченный продукт
хранение готовых продуктов без маркировки; продукт без маркировки; просроченный продукт; продукт с плесенью / гнилью; плесень; гнилой; гниль; плесневелый; плесневелое

Нарушения при работе с тестом
использование холодного теста; использование ненагретого теста; использование несозревшего теста; использование перегретого теста; тесто принимают без перчаток; тесто принимают без фартука, головного убора; тесто на полу; тесто в закрытие не списали

Нарушение дезинфекции и санитарной обработки
химию с поверхности не смыли; химию не смыли с поверхностей (линия, крышка саладетты); химия на пищевой поверхности, стол не опищевили; не опищевили поверхность после контакта с химией

Едят, курят, в зеленой зоне / форме
личные напитки в зеленой зоне; едят в зеленой зоне; жуют в зеленой зоне; курение в форме; бросаются едой

Безопасность при заготовке салатов и чикен роллов
заготовлен вне ХЦ; заготовили вне ХЦ; чикен ролл не в ХЦ; салат не в ХЦ; ЧР не в ХЦ; заготовили в ГЦ; заготовили на упаковке; заготовили на грязной доске; грязная доска и нож; овощи помыты в грязном лексане; айсберг не помыли; черри не помыли; салат не помыли; использование айсберга который касался поверхности стола для салата; айсберг на столе; айсберг; салат; кочан; качан; черри; с линии; из линии; в салат; в чикен ролл; в салат ролл; в ЧР

Прочие нарушения
продукт которого нет в меню; работа с продуктом без перчаток при наличии пластыря на пальце; упаковку протыкают ножом/ножницами (риск попадания фрагментов); упавший фартук не отправили на стирку; упавший предмет не отмыли, продолжили работу; упавшая тряпка использована повторно; подняли ингредиент с линии в продукт; не маркировали продукт после вскрытия`;
  ...
  function renderUngrouped(listEl, items) {
    ...
    for (const it of items) {
      const li = document.createElement('li');
      li.className = 'result-item';
      li.innerHTML = `${escapeHtml(it.text)} <span class="badge page-badge">стр. ${it.page}</span>${it.count > 1 ? ` <span class="badge count-badge">×${it.count}</span>` : ''}`;
      listEl.appendChild(li);
    }
  }
